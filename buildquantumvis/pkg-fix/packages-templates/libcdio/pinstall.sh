...
if [ "$LIBCDIOEXIST" ];then #140204
 ...
 ln -snf $BASEEXIST usr/lib/libcdio.so.7
 ln -snf $BASEEXIST usr/lib/libcdio.so.12
 ln -snf $BASEEXIST usr/lib/libcdio.so.19
fi
...
if [ "$LIB9660EXIST" ];then #140204
 ...
 ln -snf $BASEEXIST usr/lib/libiso9660.so.7
 ln -snf $BASEEXIST usr/lib/libiso9660.so.5
 ln -snf $BASEEXIST usr/lib/libiso9660.so.11
fi
